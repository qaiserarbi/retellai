...
/**
 * Request body for updating a Retell LLM response engine. All fields are optional.
 *
...
public record UpdateRetellLlmRequest(
    ...
    /** Fluent builder for {@link UpdateRetellLlmRequest}. */
    public static final class Builder {
        ...
        public UpdateRetellLlmRequest build() {
            return new UpdateRetellLlmRequest(model, s2sModel, modelTemperature, modelHighPriority,
