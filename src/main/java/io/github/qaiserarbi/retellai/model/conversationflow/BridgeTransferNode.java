...
/**
 * A node that initiates a warm transfer by bridging the call.
 *
 ...
 * @param instruction          what to say while bridging (used when speaking during execution).
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record BridgeTransferNode(
        String id,
        String name,
