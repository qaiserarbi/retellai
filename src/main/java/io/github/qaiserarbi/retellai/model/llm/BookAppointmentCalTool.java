...
/**
 * A tool that books an appointment for a Cal.com event.
 *
 ...
 * @param timezone    IANA timezone to use when booking the appointment.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record BookAppointmentCalTool(
        String name,
        String description,
        String calApiKey,
